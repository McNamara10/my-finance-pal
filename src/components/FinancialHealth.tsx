  ...
  return (
    <div className="widget-card animate-fade-in" style={{ animationDelay: "0.6s" }}>
      ...
      <div className="space-y-3">
        {/* Nuovo: Budget Preventivato Card */}
        <div className="flex items-center justify-between p-4 rounded-xl bg-primary/5 border border-primary/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Budget Preventivato</p>
              <p className="text-lg font-bold text-foreground">
                €{(parseFloat(localStorage.getItem("sim_baseCost") || "500")).toLocaleString('it-IT', { minimumFractionDigits: 2 })}
              </p>
            </div>
          </div>
        </div>
