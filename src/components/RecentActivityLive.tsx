      ...
      <div className="widget-card animate-fade-in" style={{ animationDelay: "0.5s" }}>
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex items-center justify-between p-3 rounded-lg bg-secondary/50 animate-pulse"
            >
      ...
      {recentTransactions.length === 0 ? (
        ...
        <div className="space-y-3">
          {recentTransactions.map((transaction) => {
            const Icon = iconMap[String(transaction.icon).toLowerCase()] || MoreHorizontal;
